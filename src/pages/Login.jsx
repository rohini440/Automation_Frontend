  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0b0f19] px-6 py-12 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md glass p-8 rounded-2xl animate-fade-in shadow-2xl relative z-10">
        ...
        <h3 className="text-lg font-semibold text-center mb-6 text-gray-200">Sign In to Dashboard</h3>
        ...
        <div className="mt-8 p-3 rounded-xl border border-gray-800 bg-[#121826]/40 text-[10px] text-gray-500 space-y-1">
          <p className="font-semibold text-emerald-500/80">⚡ Local Testing (Mock DB Mode):</p>
          <p>Login directly with the initialized admin account:</p>
          <p><span className="font-medium text-gray-400">Email:</span> admin@inventory.com</p>
          <p><span className="font-medium text-gray-400">Password:</span> password123</p>
        </div>
      </div>
    </div>
  );
